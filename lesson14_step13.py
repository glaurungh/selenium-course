...
class TestWelcome(unittest.TestCase):
    def test_welcome1(self):
        self.assertEqual(get_welcome_text("http://suninjuly.github.io/registration1.html"), "Congratulations! You have successfully registered!", "Should be correct welcome text")
        
    def test_welcome2(self):
        self.assertEqual(get_welcome_text("http://suninjuly.github.io/registration2.html"), "Congratulations! You have successfully registered!", "Should be correct welcome text")
